        ...
        if (strtotime($expiry) < time()) {
            ...
            if ($_SERVER["REQUEST_METHOD"] === "POST") {
                ...
                if ($password !== $confirm_password) {
                    Alert::SetAlert(AlertVariants::DANGER, "Passwords do not match. Please try again.");
                } else {
...
<body>
    <div class="auth-container">
        ...
        <!-- Right form -->
        <div class="auth-form">
            <form action="reset.php?token=<?php echo htmlspecialchars($_GET['token']); ?>" method="POST" class="auth-form-form">
