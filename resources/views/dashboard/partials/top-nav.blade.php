<nav class="flex justify-between bg-white dark:bg-gray-900 border-b transition-all duration-250 ease-in-out">
    ...
    <div class="flex">
      ...
      <!-- Appointments -->
       <div class="relative">
        ...
        <ul x-show="isDropdownOpen" x-transition class="absolute bg-white dark:bg-gray-900 w-full left-0 border z-10">
          <li>
            <a href="/dashboard/appointments" class="flex items-center px-4 py-2 space-x-4 hover:bg-gray-200 dark:hover:bg-gray-600 border-b block px-4">
              <i class="fas fa-eye"></i>
              <span>View Appointments</span>
            </a>
          </li>
          <li>
            <a href="/dashboard/appointments/create-step-one" class="flex items-center px-4 py-2 space-x-4 hover:bg-gray-200 dark:hover:bg-gray-600 border-b block px-4">
  ...
  <div class="relative">
    ...
    <ul x-show="isUserSidebarOpen" x-transition class="absolute bg-white dark:bg-gray-900 w-full left-0 border z-10">
      <li>
        <a href="{{ route('dashboard.profile.edit') }}" class="flex items-center px-4 py-2 space-x-4 hover:bg-gray-200 dark:hover:bg-gray-600 border-t block px-4">
