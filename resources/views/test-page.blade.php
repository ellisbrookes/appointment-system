...
@section('content')
  ...
  <section id="features" class="bg-blue-100 border-b-2 border-gray-200 py-12 px-4">
  ...
  <section id="pricing" class="bg-white border-b-2 border-gray-200 py-12 px-4">
    <div class="container mx-auto text-center">
      <h2 class="text-4xl font-bold mb-8">Pricing</h2>
      <div class="flex justify-around gap-8">
        @foreach (['Basic' => '£10/month', 'Advanced' => '£20/month', 'Pro' => '£40/month'] as $plan => $price)
          <div class="bg-white rounded-lg shadow-lg p-8 max-w-sm transition-transform hover:shadow-lg hover:translate-y-[-10px]">
            <h3 class="text-2xl font-semibold mb-4">{{ $plan }}</h3>
            <p class="text-xl mb-4">{{ $price }}</p>
            <ul class="list-none mb-4">
              <li>Feature 1</li>
              <li>Feature 2</li>
              <li>Feature 3</li>
            </ul>
            <button class="bg-blue-600 text-white py-2 px-4 rounded-md hover:bg-blue-700">Choose Plan</button>
          </div>
        @endforeach
      </div>
    </div>
  ...
  <section id="statistics" class="bg-gray-50 border-b-2 border-gray-200 py-12 px-4">
    <div class="container mx-auto text-center">
  ...
  <section id="contact" class="bg-blue-100 border-b-2 border-gray-200 py-12 px-4">
    <div class="container mx-auto text-center">
