...
<div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 8px; overflow: hidden; border: 1px solid #e5e7eb;">
    ...
    <div style="padding: 24px;">
        ...
        <p style="margin: 16px 0 16px; font-size: 16px;">Your appointment has been successfully cancelled. Here are the
            original details for your reference:</p>
    </div>
    ...
    <div style="padding: 0 24px 16px; margin-top: -10px;">
        ...
        <div style="background-color: #fef2f2; border: 1px solid #fca5a5; padding: 16px; border-radius: 8px;">
            ...
            <p style="margin: 0 0 8px; font-size: 16px;">
                <strong>Date:</strong> {{ Carbon::parse($date)->format('jS F Y') }}</p>
            <p style="margin: 0; font-size: 16px;">
                <strong>Time:</strong> {{ Carbon::parse($timeslot)->format('g:i A') }}</p>
        </div>
    </div>

    <div style="padding: 0 24px 24px;">
        <p style="margin: 0 0 16px; font-size: 16px;">If this was a mistake or you want to reschedule, please get in
            touch with us.</p>
        <a href="#"
           style="display: inline-block; background-color: #991b1b; color: #ffffff; text-decoration: none; font-weight: bold; padding: 12px 24px; border-radius: 6px; font-size: 16px;">Contact
            Us</a>
    </div>
