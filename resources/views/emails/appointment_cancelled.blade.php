    ...
    >
        ...
        >
            ...
            <div style="padding: 24px">
                ...
                <p style="margin: 16px 0 16px; font-size: 16px">
                    Your appointment has been successfully cancelled. Here are
                    the original details for your reference:
                </p>
            </div>
            ...
            <div style="padding: 0 24px 24px">
                <p style="margin: 0 0 16px; font-size: 16px">
                    If this was a mistake or you want to reschedule, please get
                    in touch with us.
                </p>
                <a
                    href="#"
