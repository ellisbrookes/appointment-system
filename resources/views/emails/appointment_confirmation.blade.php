...
<div style="max-width: 600px; margin: 0 auto; background-color: #ffffff; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1); border-radius: 8px; overflow: hidden; border: 1px solid #e5e7eb;">
    ...
    <div style="padding: 0 24px 24px;">
        <p style="margin: 0 0 16px; font-size: 16px;">If you have any questions or need to make changes to your
            appointment, feel free to contact us.</p>
        <a href="#"
           style="display: inline-block; background-color: #2563eb; color: #ffffff; text-decoration: none; font-weight: bold; padding: 12px 24px; border-radius: 6px; font-size: 16px;">Contact
            Us</a>
    </div>
